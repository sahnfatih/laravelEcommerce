      ...
      <div class="table-responsive">
        <form action="{{url("/users/$user->user_id")}}" method="POST" autocomplete="off" >
            ...
            <div class="row">
                 ...
                 <input class="form-check-input" type="checkbox"  id="is_admin" name="is_admin" value="1" {{$user->is_admin == 1 ? "checked" : ""}}></input>
        ...
        <div class="col-lg-6">
                ...
                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{$user->is_active == 1 ? "checked" : ""}}></input>
