            ...
            <div class="col-lg-6">
                <div class="mt-2">
                    ...
                    <input type="text" class="form-control" id="name" name="name"
                           value="{{old('name', $product->name)}}" placeholder="Ürün adı giriniz">
                    @error("name")
            ...
            <div class="col-lg-6">
                <div class="mt-2">
                    ...
                    <input type="number" step="0.01" class="form-control" id="price" name="price"
                           value="{{old('price', $product->price)}}" placeholder="Fiyat giriniz">
                    @error("price")
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
            ...
            <div class="col-lg-6">
                <div class="mt-2">
                    ...
                    <input type="number" step="0.01" class="form-control" id="old_price" name="old_price"
                           value="{{old('old_price', $product->old_price)}}" placeholder="Eski fiyat giriniz">
                    @error("old_price")
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
            ...
            <div class="col-lg-12">
                <div class="mt-2">
                    ...
                    <input type="text" class="form-control" id="lead" name="lead"
                           value="{{old('lead', $product->lead)}}" placeholder="Kısa açıklama giriniz">
                    @error("lead")
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
            ...
            <div class="col-lg-12">
                <div class="mt-2">
                    ...
                    <textarea class="form-control" id="description" name="description"
                              placeholder="Detaylı açıklama giriniz">{{old('description', $product->description)}}</textarea>
                    @error("description")
                    <span class="text-danger">{{$message}}</span>
                    @enderror
                </div>
